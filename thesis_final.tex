...
\end{itemize}
のそれぞれの機能を利用して実装した．
blogの作成から公開までの流れは図\ref{fig:org7e767b8}のようになる．

\subsubsection{my\_help = 直交補空間}
\label{sec:orgd5012e3}
