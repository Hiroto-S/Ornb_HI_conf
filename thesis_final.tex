...
\label{sec:org978852e}
\subsection{ゼミナール}
\label{sec:org64a4937}
...
\section{徒弟制の見直し}
\label{sec:org98a9f41}
\subsection{状況に埋め込まれた学習}
\label{sec:orge3c6ec1}
1991年にレイヴとウェンガーによって，
...
\end{itemize}
のそれぞれの機能を利用して実装した．
blogの作成から公開までの流れは図\ref{fig:orgc2d094b}のようになる．

\subsubsection{my\_help = 直交補空間}
\label{sec:org607548b}
