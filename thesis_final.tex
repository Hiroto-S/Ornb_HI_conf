...
\bibitem{Org-mode} Org mode for Emacs: あなたの生活をプレーンテキストで， https:\slash\slash{}orgmode.org\slash{}ja\slash{} (accessed on 10 Feb 2019)．
...
\bibitem{VSC}  ［速報］「Visual Studio Live Share」発表。複数のプログラマがリアルタイムにコードの編集、ブレークポイント、デバッガ操作などを共有。Connect(); 2017; https:\slash\slash{}www.publickey1.jp\slash{}blog\slash{}17\slash{}visual_studio_live_shareconnect_2017.html (accessed on 7 July 2019)．
