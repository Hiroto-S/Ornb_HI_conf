...
\section{徒弟制の見直し}
\label{sec:org3e34ba8}
\subsection{状況に埋め込まれた学習}
\label{sec:orgb72c6a4}
1991年にレイヴとウェンガーによって，
...
\end{itemize}
のそれぞれの機能を利用して実装した．
blogの作成から公開までの流れは図\ref{fig:orge17266d}のようになる．

\subsubsection{my\_help = 直交補空間}
\label{sec:org9124b5c}
