...
\label{sec:org7995675}
\subsection{背景I - 大学の学び}
\label{sec:org11c85da}
...
\section{徒弟制の見直し}
\label{sec:org717eec5}
\subsection{状況に埋め込まれた学習}
\label{sec:org102658f}
1991年にレイヴとウェンガーによって，
...
表\ref{tab:org2d7bc60}

\begin{table}[bt]
\caption{\label{tab:org2d7bc60}
